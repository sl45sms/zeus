...
BOOTH.setup_election = function(raw_json) {
  ...
  var module_cls = BM.get_module(BOOTH.election.election_module);
  BOOTH.module = new module_cls(BOOTH.election);
  ...
  $(['description', 'name', 'full_name', 'election_name']).each(function(i, field) {
